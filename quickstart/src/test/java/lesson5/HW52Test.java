...
class HW52Test {
 ...
 @Test
     ...
     Thread.sleep(5000);
             ...
             driver.findElement
                     (By.xpath("//footer[@class='footer']//div[@class='footer__container footer__copyright-container container']/section/a[@href='https://www.instagram.com/defo_office/']")).click();
